...
func getDefaultValidators() map[validatorID]ValidatorConfig {
	return map[validatorID]ValidatorConfig{
		...
		validatorID("bob"): {
			...
			consumerPubKey:   `{"@type":"/cosmos.crypto.ed25519.PubKey","key":"5ekRfVUhYeWH0Oi6g5wyQARoDlkyU3k6TUYSFV/XZ2M="}`,
		...
		validatorID("carol"): {
			...
			consumerPubKey:   `{"@type":"/cosmos.crypto.ed25519.PubKey","key":"fOOpR6UapanE4Pn+JTC8Sw1VDUZYvC036lcZU3q1H/c="}`,
