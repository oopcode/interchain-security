...
func getDefaultValidators() map[validatorID]ValidatorConfig {
	return map[validatorID]ValidatorConfig{
		...
		validatorID("bob"): {
			...
			consumerPubKey:   `{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AkqjAHI+flxTJ4Fr8Il/NvTKeN1w6uCpDhgfVVAlG9Eu"}`,
		...
		validatorID("carol"): {
			...
			consumerPubKey:   `{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AyM+CKzFKY+WwYVYmOShkgshJW4pjwqKVlKKxrQ69yhF"}`,
